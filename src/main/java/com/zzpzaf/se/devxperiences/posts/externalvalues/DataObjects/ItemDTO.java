...
import com.zzpzaf.se.devxperiences.posts.externalvalues.Validators.DBMasterDetails;
...
public class ItemDTO {
    ...
    // @Positive
    // @Positive( message = "The Item Price should be a posituve number." )
    @Positive(message = "{items.price.positive}")
